        ...
        <div class="d-flex align-items-center gap-lg-2 gap-1">
            ...
            <div class="logo-topbar">
                ...
                <a href="index.php" class="logo-light">
                    ...
                    <span class="logo-sm">
                        <img src="assets/images/logo.svg" alt="small logo">
                    </span>
                </a>
                ...
                <a href="index.php" class="logo-dark">
                    <span class="logo-lg">
                        <img src="assets/images/logo.svg" alt="dark logo">
                    </span>
                    <span class="logo-sm">
                        <img src="assets/images/logo.svg" alt="small logo">
                    </span>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="d-lg-flex flex-column gap-1 d-none">
                        <h5 class="my-0"><?php echo $_SESSION['userFullName'] ?></h5>
                        <h6 class="my-0 fw-normal">
                            ...
                            try {
                                ...
                                if (!isset($_SESSION['userrole'])) {
                                    throw new Exception("User role not set in session.");
                                }
                                $userRoleId = $_SESSION['userrole'];

                                // Prepare the statement to fetch the role name based on the role ID
                            ...
                            echo htmlspecialchars($userRoleName);
                            ?>
                        </h6>
                    </span>
